...
fig, ax = plt.subplots() 
ax.scatter(fill_list_scan2, R_list_scan2*100, color='darkcyan', marker='.', s=50, label='delta_k')
...
fig, ax = plt.subplots() 
ax.scatter(fill_list_scan2, chi_list_scan2, color='darkcyan', marker='.', s=50, label='delta_k')
...
fig, ax = plt.subplots() 
ax.scatter(fill_list_scan2, k_list_scan2, color='darkcyan', marker='.', s=50, label='delta_k')
...
fig, ax = plt.subplots() 
ax.scatter(fill_list_scan2, B_list_scan2, color='darkcyan', marker='.', s=50, label='delta_k')
...
fig, ax = plt.subplots() 
ax.scatter(fill_list_scan2, Eps_list_scan2*1e9,color='darkcyan', marker='.', s=50, label='delta_k')
...
fig, ax = plt.subplots() 
ax.scatter(fill_list, delta_k2,color='slateblue', marker='.', s=50, label='delta_k')
...
fig, ax = plt.subplots() 
ax.scatter(fill_list, delta_k2, color='royalblue',marker='.', s=50, label='delta_k')
ax.set_title(r'$20%s$: $\Delta \kappa$' % str(year))
...
fig, ax = plt.subplots() 
ax.scatter(fill_list, delta_B2, color='royalblue', marker='.', s=50, label='delta_k')
...
fig, ax = plt.subplots() 
ax.scatter(fill_list, delta_eps_ni2*1e9, color='royalblue', marker='.', s=50, label='delta_k')
...
fig, ax = plt.subplots() 
ax.scatter(fill_list, delta_R2,color='royalblue', marker='.', s=50, label='delta_k')
...
fig, ax = plt.subplots() 
ax.scatter(fill_list, delta_eps_ni2/Eps_list, color='red', marker='.', s=50, label='delta_k')
...
fig, ax = plt.subplots() 
ax.scatter(fill_list, delta_B2/B_list, color='red', marker='.', s=50, label='delta_k')
...
fig, ax = plt.subplots() 
ax.scatter(fill_list, delta_k2/k_list, color='red', marker='.', s=50, label='delta_k')
...
fig, ax = plt.subplots() 
ax.scatter(fill_list, delta_R2/(R_list*100), color='red', marker='.', s=50, label='delta_k')
...
fig, ax = plt.subplots() 
ax.scatter(fill_list, Eps_list_scan2/Eps_list, color='orchid', marker='.', s=50, label='delta_k')
...
fig, ax = plt.subplots() 
ax.scatter(fill_list, B_list_scan2/B_list, color='orchid', marker='.', s=50, label='delta_k')
...
fig, ax = plt.subplots() 
ax.scatter(fill_list, k_list_scan2/k_list, color='orchid', marker='.', s=50, label='delta_k')
...
fig, ax = plt.subplots() 
ax.scatter(fill_list, R_list_scan2/R_list, color='orchid', marker='.', s=50, label='delta_k')
