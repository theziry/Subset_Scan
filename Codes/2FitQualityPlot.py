...
for i in range(len(FillNumber)):
    ...
    plt.savefig('20{}/scan/quality/{}_k_chi_2fit_first.pdf'.format(str(year),text))
    plt.savefig('20{}/scan/quality/img/{}_k_chi_2fit_first.png'.format(str(year),text))
    ...
    ax.set_ylabel('${\chi}^2$') 
    ax.set_title('FillNumber: {}'.format(text))
    plt.savefig('20{}/scan/quality/{}_CHI_k_2fit_first_zoom.pdf'.format(str(year),text))
    plt.savefig('20{}/scan/quality/img/{}_CHI_k_2fit_first_zoom.png'.format(str(year),text))
    ...
    ax.set_title('FillNumber: {}'.format(text))
    plt.savefig('20{}/scan/quality/{}_k_R_2fit_first.pdf'.format(str(year),text))
    plt.savefig('20{}/scan/quality/img/{}_k_R_2fit_first.png'.format(str(year),text))
    ...
    ax.set_title('FillNumber: {}'.format(text))
    plt.savefig('20{}/scan/param/{}_k_Rho_2fit_first.pdf'.format(str(year),text))
    plt.savefig('20{}/scan/param/img/{}_k_Rho_2fit_first.png'.format(str(year),text))
    ...
    ax.set_title('FillNumber: {}'.format(text))
    plt.savefig('20{}/scan/param/{}_k_Eps_2fit_first.pdf'.format(str(year),text))
    plt.savefig('20{}/scan/param/img/{}_k_Eps_2fit_first.png'.format(str(year),text))
    ...
    ax.set_ylabel('${\chi}^2$') 
    ax.set_title('FillNumber: {}'.format(text))
    plt.savefig('20{}/scan/quality/{}_k_chi_2fit_last.pdf'.format(str(year),text))
    plt.savefig('20{}/scan/param/img/{}_k_chi_2fit_last.png'.format(str(year),text))
    ...
    ax.set_ylabel('${\chi}^2$') 
    ax.set_title('FillNumber: {}'.format(text))
    plt.savefig('20{}/scan/quality/{}_CHI_k_2fit_last_zoom.pdf'.format(str(year),text))
    plt.savefig('20{}/scan/param/img/{}_CHI_k_2fit_last_zoom.png'.format(str(year),text))
    ...
    ax.set_ylabel('${R_{adj}}$$^2${({\%})}' )
    ax.set_title('FillNumber: {}'.format(text))
    plt.savefig('20{}/scan/quality/{}_k_R_2fit_last.pdf'.format(str(year),text))
    plt.savefig('20{}/scan/quality/img/{}_k_R_2fit_last.png'.format(str(year), text))
    ...
    ax.set_ylabel(r'$\rho_\ast$') 
    ax.set_title('FillNumber: {}'.format(text))
    plt.savefig('20{}/scan/param/{}_k_Rho_2fit_last.pdf'.format(str(year),text))
    plt.savefig('20{}/scan/param/img/{}_k_Rho_2fit_last.png'.format(str(year),text))
    ...
    ax.set_ylabel(''r' ${\epsilon}*{N_i}${(10$^{-9}$)}') 
    ax.set_title('FillNumber: {}'.format(text))
    plt.savefig('20{}/scan/param/{}_k_Eps_2fit_last.pdf'.format(str(year),text))
    plt.savefig('20{}/scan/param/img/{}_k_Eps_2fit_last.png'.format(str(year),text))
